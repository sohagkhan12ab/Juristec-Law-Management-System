    ...
    public function run()
    {
        $template = [
            ...
            [
                ...
                'field_json'=>'{"field":[{"label":"Case highlights","placeholder":"your case highlights in keywords","field_type":"text_box","field_name":"keywords"},{"label":"Description","placeholder":"your case brief","field_type":"textaera","field_name":"decsription"}]}',
                'is_tone'=> 0,
                "created_at" => date('Y-m-d H:i:s'),
                "updated_at" => date('Y-m-d H:i:s'),
            ],
            [
                ...
                'field_json'=>'{"field":[{"label":"Case Title","placeholder":"your case title","field_type":"text_box","field_name":"title"},{"label":"Brief Case highlights","placeholder":"your case highlights in brief keywords","field_type":"textaera","field_name":"description"}]}',
                'is_tone'=> 0,
                "created_at" => date('Y-m-d H:i:s'),
                "updated_at" => date('Y-m-d H:i:s'),
            ],
            [
                ...
                'field_json'=>'{"field":[{"label":"Document description","placeholder":"case evidance","field_type":"textaera","field_name":"description"}]}',
                'is_tone'=> 0,
                "created_at" => date('Y-m-d H:i:s'),
                "updated_at" => date('Y-m-d H:i:s'),
            ],
