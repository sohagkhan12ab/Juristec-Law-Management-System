...
class SettingController extends Controller
{
    ...
    public function CookieConsent(Request $request)
    {
        ...
        if ($settings['enable_cookie'] == "on" && $settings['cookie_logging'] == "on") {
            ...
            if (!file_exists(storage_path() . '/app/public/uploads/sample/data.csv')) {
                ...
                file_put_contents(storage_path() . '/app/public/uploads/sample/data.csv', $first_line . PHP_EOL, FILE_APPEND | LOCK_EX);
            }
            file_put_contents(storage_path() . '/app/public/uploads/sample/data.csv', $new_line . PHP_EOL, FILE_APPEND | LOCK_EX);
    ...
    public function SeoSettings(Request $request)
    {
        ...
        if (!empty($request->meta_image)) {
            if ($request->meta_image) {
                ...
                $path = storage_path('app/public/uploads/metaevent/' . Utility::getSeoSetting()['meta_image']);
            ...
            $dir = 'app/public/uploads/metaevent';
            $validation = [
                'max:' . '20480',
            ];
