            ...
            <div class="card shadow-none rounded-0 border-bottom">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center justify-content-end">
                        ...
                        <div class="row">
                            <div class="col-auto">
                                <div class="action-btn bg-light-secondary  col-auto ">
                                ...
                                <div class="action-btn bg-light-secondary col-auto " style="margin-left:5px">
                                    <a href="{{ url('userlog') }}" data-bs-toggle="tooltip"
                                        title="{{ __('Reset') }}"data-title="{{ __('Reset') }}"
                                        class="m-1 btn btn-sm align-items-center text-dark "><i
