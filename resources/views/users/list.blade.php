                                ...
                                @foreach ($users as $key => $user)
                                    <tr>
                                        ...
                                        @if (Auth::user()->type == 'super admin')
                                            ...
                                            <td>{{ $user->plan_expire_date ? date('d-m-Y', strtotime($user->plan_expire_date)) : '-' }}</td>
                                        @endif
                                        <td>
                                                ...
                                                <div class="action-btn bg-light-secondary ms-2">
                                                    ...
                                                    @if ($user->is_enable_login == 1)
                                                        <a href="{{ route('users.login', \Crypt::encrypt($user->id)) }}"
                                                            data-bs-toggle="tooltip"  data-tooltip="Login Disable" title="{{ __('Login Disable') }}"
                                                            class="mx-3 btn btn-sm d-inline-flex align-items-center">
                                                    ...
                                                    @elseif ($user->is_enable_login == 0 && $user->password == null)
                                                        <a href="#"
                                                            ...
                                                            data-bs-toggle="tooltip"  data-tooltip="Login Enable" title="{{ __('Login Enable') }}"
                                                            data-ajax-popup="true" data-size="md"
                                                            class="mx-3 btn btn-sm d-inline-flex align-items-center login_enable"
                                                            data-title="{{ __('New Password') }}" class="mx-3 btn btn-sm d-inline-flex align-items-center">
                                                            <i class="ti ti-road-sign"></i>
                                                        </a>
                                                    @else
                                                        <a href="{{ route('users.login', \Crypt::encrypt($user->id)) }}"
