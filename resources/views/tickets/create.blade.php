            ...
            <div class="p-3">
                <div class="card shadow-none rounded-0 border">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-xl-10 col-md-10 col-sm-10 col-6">{{ __('Ticket Information') }}</div>
                                @if ($chatgpt_enable)
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select
                                            class="form-control {{ !empty($errors->first('category')) ? 'is-invalid' : '' }}"
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input
                                            class="form-control {{ !empty($errors->first('subject')) ? 'is-invalid' : '' }}"
